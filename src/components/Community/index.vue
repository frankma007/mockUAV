          ...
          <TabPane v-for="(item, index) in list2" :key="index" :label="item" name="推荐">
            <div>
              ...
              <div class="tab-swiper vux-center">
                <div v-if="index==0">
                  <div class="info-item" @click="openUrl(ritem)" v-for="(ritem,rindex) in recommend" :key="rindex">
                    ...
                    <div v-if="ritem.imgs&&(ritem.imgs.length>=3||ritem.imgs.length==2)" class="img-group">
                      <img v-for="(img,imageIndex) in ritem.imgs" :key="imageIndex" v-bind:src="img" />
                    </div>
                    <div class="info-foot">
